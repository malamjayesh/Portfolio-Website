            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-10 md:gap-12 items-center">
              ...
              >
                <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4 sm:mb-6">
                  Product People. Technology Experts. Partners in Growth.
                </h2>
                <p className="text-muted-foreground mb-4 leading-relaxed">
                  FlexaDigital is a compact, cross-disciplinary product studio
                  that partners with founders and enterprise teams to design,
                  build and scale digital products. We combine strategic product
                  discovery, refined UX practices and reliable engineering to
                  turn ideas into revenue-generating experiences.
                </p>
                <p className="text-muted-foreground leading-relaxed">
                  Our approach combines technical excellence with user-centered
                  design, ensuring that every project we deliver not only meets
          ...
          <div className="container mx-auto px-6">
            <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
              <div className="bg-background border border-border rounded-2xl p-8">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Build honest, scalable digital products that deliver
              ...
              <div className="bg-background border border-border rounded-2xl p-8">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  To be the go-to engineering partner for startups and
                  growth-stage companies that want predictable outcomes and fast
                  iteration.
                </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 md:gap-8">
              {[
                ...
                },
                {
                  title: 'Transparency',
                  description:
                    'Clear communication, visible progress and honest expectations throughout every project.',
                },
                {
                  title: 'Empathy',
                  description:
                    'We listen deeply to understand your users and business needs before we build.',
                },
                {
                  title: 'Measurable Outcomes',
                  description:
                    'We track KPIs and measure real business impact—not just feature delivery.',
                },
              ].map((value, index) => (
                <motion.div
                  key={index}
              ...
              {[
                {
                  year: '2020',
                  title: 'Founded',
                  desc: 'Started with 2 developers',
                  metric: '2 Team Members',
                },
                {
                  year: '2021',
                  title: 'First Enterprise Client',
                  desc: 'Landed Fortune 10 contract',
                  metric: '50+ lakhs revenue',
                },
                {
                  year: '2022',
                  title: 'Global Expansion',
                  desc: 'Opened offices in 3 countries',
                  metric: '10+ Projects',
                },
                {
                  year: '2023',
                  title: 'AI Integration',
                  desc: 'Launched AI-powered solutions',
                  metric: '20+ Projects',
                },
                {
                  year: '2024',
                  title: 'Industry Leader',
                  desc: 'Recognized as top digital agency',
                  metric: '30+ Projects',
                },
              ].map((milestone, index) => (
                <motion.div
