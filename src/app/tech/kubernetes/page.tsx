...
const Kubernetes = () => {
  const features = [
    ...
    {
      title: 'Service Mesh',
      description: 'Advanced service-to-service communication',
      icon: CheckCircle2,
    },
    {
      title: 'Self-healing',
      description: 'Automatic container recovery and restart',
      icon: Shield,
    },
    {
          ...
          <div className="container mx-auto px-6 relative z-10">
            ...
            >
              ...
              >
                <Button
                  size="lg"
                  className="bg-gradient-to-r from-blue-500 to-cyan-500 text-white text-lg px-8 py-6 rounded-full hover:shadow-glow transition-all"
                >
