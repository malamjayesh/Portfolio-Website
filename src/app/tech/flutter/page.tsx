  ...
  const features = [
    {
      ...
      description: 'Next-gen rendering engine for smooth animations',
      icon: Zap,
    },
    {
      title: 'Material 3',
    ...
    {
      title: 'Web Support',
      description: 'Deploy to web alongside mobile',
      icon: Globe,
    },
    {
      title: 'Hot Reload',
    ...
    },
    {
      ...
      description: 'Compiled to native ARM code',
      icon: CheckCircle2,
    },
  ];
          ...
          <div className="container mx-auto px-6 relative z-10">
            ...
            >
              ...
              >
                <Button
                  size="lg"
                  className="bg-gradient-to-r from-cyan-500 to-blue-500 text-white text-lg px-8 py-6 rounded-full hover:shadow-glow transition-all"
                >
          ...
          <div className="container mx-auto px-6 text-center relative z-10">
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-6 justify-center">
                <Button
                  size="lg"
                  className="bg-white text-cyan-600 text-lg px-8 py-6 rounded-full hover:shadow-glow"
                  asChild
                >
                  <Link href="/contact">
