...
import { Star, Play, CheckCircle2, Rocket, Award, Cloud, Shield, Zap, Database } from "lucide-react";
import Link from "next/link";
import { motion } from "framer-motion";

const AWS = () => {
  const features = [
    { title: "Lambda Functions", description: "Serverless compute for event-driven applications", icon: Zap },
    { title: "ECS & EKS", description: "Container orchestration at scale", icon: Rocket },
    { title: "RDS & DynamoDB", description: "Managed database solutions", icon: Database },
    { title: "CloudFront CDN", description: "Global content delivery network", icon: Cloud },
    { title: "Security & IAM", description: "Enterprise-grade security controls", icon: Shield },
    { title: "Auto Scaling", description: "Automatic resource optimization", icon: CheckCircle2 }
  ];

  const stats = [
    { number: "200+", label: "AWS Projects", icon: Rocket },
    { number: "99%", label: "Client Satisfaction", icon: Star },
    { number: "40%", label: "Cost Savings", icon: Zap },
          ...
          <div className="container mx-auto px-6 relative z-10">
            <motion.div initial={{ opacity: 0, y: 50 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} className="text-center mb-16">
              ...
              <h1 className="text-6xl md:text-8xl font-bold mb-8">
                <span className="bg-gradient-to-r from-orange-500 via-amber-500 to-yellow-500 bg-clip-text text-transparent">AWS</span>
                <br />
                <span className="text-foreground">Platform</span>
              </h1>
              <p className="text-2xl text-muted-foreground max-w-4xl mx-auto mb-12 leading-relaxed">
                Comprehensive cloud ecosystem for scalable applications
              </p>
              ...
              <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 1.5 }}>
                <Button size="lg" className="bg-gradient-to-r from-orange-500 to-amber-500 text-white text-lg px-8 py-6 rounded-full hover:shadow-glow transition-all">
        ...
        <section className="py-24 bg-background">
          <div className="container mx-auto px-6">
            <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-16">
              <h2 className="text-5xl font-bold mb-6">AWS Services</h2>
              <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
                Powerful cloud services for modern applications
              </p>
            </motion.div>
          ...
          <div className="container mx-auto px-6 text-center relative z-10">
            <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
              ...
              <div className="flex flex-col sm:flex-row gap-6 justify-center">
                <Button size="lg" className="bg-white text-orange-600 text-lg px-8 py-6 rounded-full hover:shadow-glow" asChild>
                  <Link href="/contact">
