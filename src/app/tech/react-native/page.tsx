...
import { Star, Play, CheckCircle2, Rocket, Award, Smartphone, Zap, Shield, Code2 } from "lucide-react";
import Link from "next/link";
import { motion } from "framer-motion";

const ReactNative = () => {
  const features = [
    { title: "New Architecture", description: "Modern rendering engine for better performance", icon: Rocket },
    { title: "Fabric Renderer", description: "Concurrent rendering capabilities", icon: Zap },
    { title: "TurboModules", description: "Faster native module loading", icon: Code2 },
    { title: "Codegen", description: "Type-safe native code generation", icon: Shield },
    { title: "Cross-platform", description: "Write once, run on iOS and Android", icon: Smartphone },
    { title: "Hot Reload", description: "Instant feedback during development", icon: CheckCircle2 }
  ];

  const stats = [
    { number: "150+", label: "React Native Apps", icon: Rocket },
    { number: "96%", label: "Client Satisfaction", icon: Star },
    { number: "70%", label: "Code Reuse", icon: Zap },
    { number: "Native", label: "Performance", icon: Smartphone }
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-secondary/20 to-background">
      ...
      <main>
          ...
          <div className="container mx-auto px-6 relative z-10">
            <motion.div initial={{ opacity: 0, y: 50 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} className="text-center mb-16">
              ...
              <h1 className="text-6xl md:text-8xl font-bold mb-8">
                <span className="bg-gradient-to-r from-blue-500 via-indigo-500 to-purple-500 bg-clip-text text-transparent">React</span>
                <br />
              ...
              <p className="text-2xl text-muted-foreground max-w-4xl mx-auto mb-12 leading-relaxed">
                Native mobile performance with React development experience
              </p>
              ...
              <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 1.5 }}>
                <Button size="lg" className="bg-gradient-to-r from-blue-500 to-indigo-500 text-white text-lg px-8 py-6 rounded-full hover:shadow-glow transition-all">
        ...
        <section className="py-24 bg-background">
          <div className="container mx-auto px-6">
            <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-16">
              <h2 className="text-5xl font-bold mb-6">React Native Features</h2>
        ...
        <section className="py-24 bg-gradient-to-r from-blue-500 to-indigo-500 relative overflow-hidden">
