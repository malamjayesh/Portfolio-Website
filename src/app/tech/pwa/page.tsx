...
const PWA = () => {
  const features = [
    ...
    {
      title: 'App Install',
      description: 'Add to home screen like native apps',
      icon: Smartphone,
    },
    {
    ...
    {
      title: 'Fast Loading',
      description: 'Instant loading with service workers',
      icon: Rocket,
    },
    {
          ...
          <div className="container mx-auto px-6 relative z-10">
            ...
            >
              ...
              >
                <Button
                  size="lg"
                  className="bg-gradient-to-r from-emerald-500 to-teal-500 text-white text-lg px-8 py-6 rounded-full hover:shadow-glow transition-all"
                >
          ...
          <div className="container mx-auto px-6 text-center relative z-10">
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-6 justify-center">
                <Button
                  size="lg"
                  className="bg-white text-emerald-600 text-lg px-8 py-6 rounded-full hover:shadow-glow"
                  asChild
                >
                  <Link href="/contact">
