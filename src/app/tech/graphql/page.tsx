...
const GraphQL = () => {
  const features = [
    {
      title: 'Type Safety',
      description: 'Strongly typed schema for reliable APIs',
      icon: Shield,
    },
    {
      title: 'Real-time Updates',
      description: 'Subscriptions for live data synchronization',
      icon: Zap,
    },
    {
      title: 'Federation',
      description: 'Microservices architecture with unified graph',
      icon: Link2,
    },
    {
      title: 'Efficient Caching',
      description: 'Smart caching strategies for optimal performance',
      icon: Database,
    },
    {
      title: 'Single Endpoint',
      description: 'One endpoint for all data requirements',
      icon: CheckCircle2,
    },
    {
      title: 'Developer Tools',
      description: 'GraphQL Playground and introspection',
      icon: Rocket,
    },
  ];
          ...
          <div className="container mx-auto px-6 relative z-10">
            ...
            >
              ...
              >
                <Button
                  size="lg"
                  className="bg-gradient-to-r from-pink-500 to-purple-500 text-white text-lg px-8 py-6 rounded-full hover:shadow-glow transition-all"
                >
          ...
          <div className="container mx-auto px-6 text-center relative z-10">
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-6 justify-center">
                <Button
                  size="lg"
                  className="bg-white text-pink-600 text-lg px-8 py-6 rounded-full hover:shadow-glow"
                  asChild
                >
                  <Link href="/contact">
