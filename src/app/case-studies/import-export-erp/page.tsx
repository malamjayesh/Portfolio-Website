        ...
        <section className="relative min-h-[50vh] flex items-center justify-center bg-gradient-hero pt-32 pb-20">
          <div className="container mx-auto px-6">
            <div className="max-w-4xl mx-auto text-center">
              ...
              >
                Streamlining global trade operations with comprehensive ERP
                integration
              </motion.p>
            </div>
          </div>
          ...
          <div className="container mx-auto px-6">
            <div className="max-w-4xl mx-auto">
              ...
              <p className="text-muted-foreground mb-6 leading-relaxed">
                Global Trading Corp was managing import-export operations across
                15 countries using fragmented systems. Manual processes led to
                customs delays, compliance issues, and lack of real-time
                visibility into shipment status. The company needed a unified
                platform to handle complex multi-country trade regulations and
                documentation.
              </p>
              ...
              <div className="space-y-8">
                <div className="flex gap-6">
                  ...
                  <div>
                    <h3 className="text-xl font-semibold mb-3">
                      Multi-Country Trade Management
                    </h3>
                    <p className="text-muted-foreground leading-relaxed">
                      Built a comprehensive ERP system with country-specific
                      trade regulations, automated customs documentation, and
                      real-time compliance monitoring across all operational
                      territories.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground leading-relaxed">
                      Developed end-to-end shipment tracking with carrier
                      integrations, automated notifications, and predictive
                      delivery analytics to optimize supply chain operations.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground leading-relaxed">
                      Implemented intelligent document generation for customs
                      forms, certificates of origin, and commercial invoices
                      with automatic validation and digital signatures.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground leading-relaxed">
                      Created comprehensive reporting system with trade
                      analytics, cost optimization insights, and performance
              ...
              <div className="bg-secondary border border-border rounded-2xl p-8">
                ...
                <p className="text-muted-foreground italic leading-relaxed mb-4">
                  "Flexa Digital's ERP solution revolutionized our import-export
                  operations. We now have complete visibility into our global
                  supply chain, and customs clearance times have improved
                  dramatically. The ROI was evident within the first quarter of
                  implementation."
                </p>
                <div className="font-semibold">
                  — Robert Chen, COO at Global Trading Corp
                </div>
              </div>
            </div>
          </div>
