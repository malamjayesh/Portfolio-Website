          ...
          <div className="container mx-auto px-6">
            <div className="max-w-4xl mx-auto">
              ...
              <p className="text-muted-foreground mb-6 leading-relaxed">
                FitLife Pro wanted to create a comprehensive fitness app that
                could track workouts, provide meal plans, and offer social
                features—all while working offline and syncing seamlessly across
                devices.
              </p>
              ...
              <div className="bg-secondary border border-border rounded-2xl p-8">
                ...
                <p className="text-muted-foreground italic leading-relaxed mb-4">
                  "The team delivered beyond expectations. The app is beautiful,
                  fast, and our users love it. The offline functionality is a
                  game-changer."
                </p>
                <div className="font-semibold">
                  — Michael Chen, Founder at FitLife Pro
                </div>
              </div>
            </div>
          </div>
