            ...
            <div className="lg:col-span-2 space-y-12">
              ...
              >
                ...
                <p className="text-muted-foreground leading-relaxed">
                  ...
                  engineering team. You will be responsible for developing and
                  maintaining scalable web applications for our Fortune 500
                  clients. This role offers the opportunity to work with
                  cutting-edge technologies and contribute to high-impact
                  projects.
                </p>
              </motion.div>
            ...
            <div className="space-y-8">
              ...
              >
                ...
                <p className="text-muted-foreground mb-6 text-sm">
                  Send us your resume and portfolio. We'll get back to you
                  within 24 hours.
                </p>
                <Dialog open={isFormOpen} onOpenChange={setIsFormOpen}>
                  <DialogTrigger asChild>
