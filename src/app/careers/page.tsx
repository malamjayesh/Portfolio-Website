...
export default function CareersPage() {
  ...
  const benefits = [
    ...
    },
    {
      ...
      description: 'Quarterly bonuses based on individual and team performance',
    },
  ];
        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          >
            ...
            <p className="text-base sm:text-lg md:text-xl text-muted-foreground mb-8 px-4">
              Be part of a team that creates exceptional digital experiences for
              clients worldwide. We're looking for passionate individuals who
        ...
        <div className="container mx-auto px-6">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold mb-6">
              Why Join FlexaDigital?
            </h2>
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
              We believe in creating an environment where talented individuals
              can thrive and grow
            </p>
          </motion.div>
                ...
                <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
                  ...
                  <div className="flex flex-col sm:flex-row gap-3">
                    <Button variant="outline" size="sm" asChild>
                      <Link
                        href={`/careers/${position.title.toLowerCase().replace(/[^a-z0-9]+/g, '-')}`}
                      >
                        Learn More
                      </Link>
                    </Button>
