            ...
            <div className="lg:col-span-2 space-y-12">
              ...
              >
                ...
                <p className="text-muted-foreground leading-relaxed">
                  We're seeking a skilled DevOps Engineer to join our
                  infrastructure team. You'll be responsible for building and
                  maintaining scalable, secure, and reliable systems that
                  support our global client projects. This is a fully remote
                  position with opportunities to work with cutting-edge cloud
                  technologies.
                </p>
              </motion.div>
            ...
            <div className="space-y-8">
              ...
              >
                ...
                <p className="text-muted-foreground mb-6 text-sm">
                  Share your experience with cloud infrastructure and automation
                  tools.
                </p>
                <Dialog open={isFormOpen} onOpenChange={setIsFormOpen}>
                  <DialogTrigger asChild>
