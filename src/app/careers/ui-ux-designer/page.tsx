            ...
            <div className="lg:col-span-2 space-y-12">
              ...
              >
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Join our design team as a UI/UX Designer and help create
                  exceptional digital experiences for our global clients. You'll
                  work on diverse projects ranging from mobile apps to
                  enterprise software, collaborating with cross-functional teams
            ...
            <div className="space-y-8">
              ...
              >
                ...
                <p className="text-muted-foreground mb-6 text-sm">
                  Send us your portfolio and resume. We'd love to see your
                  design work!
                </p>
                <Dialog open={isFormOpen} onOpenChange={setIsFormOpen}>
                  <DialogTrigger asChild>
