      ...
      <div className="bg-gradient-hero relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 py-16 relative z-10">
          <div className="max-w-5xl mx-auto">
            ...
            {/* Quick Navigation */}
            <div
              className="bg-card/30 backdrop-blur-sm rounded-xl border border-border/50 p-6 mb-12 animate-fade-in"
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                {[
                  ...
                  <a
                    key={index}
                    href={item.href}
                    className="text-sm text-muted-foreground hover:text-primary transition-colors p-2 rounded-lg hover:bg-primary/5 flex items-center gap-2"
                  >
            ...
            <div className="space-y-8">
              ...
              <section
                id="collection"
                className="bg-card/40 backdrop-blur-sm rounded-xl border border-border/50 p-8 hover:border-primary/30 transition-all duration-300 group"
              >
              ...
              <section
                id="rights"
                className="bg-gradient-card rounded-xl border border-primary/20 p-8"
              >
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="grid md:grid-cols-2 gap-4">
                      {[
                        {
                          title: 'Access',
                          desc: 'View all data we have about you',
                        },
                        {
                          title: 'Update',
                          desc: 'Modify your personal information',
                        },
                        {
                          title: 'Delete',
                          desc: 'Request complete data removal',
                        },
                        {
                          title: 'Portability',
                          desc: 'Export your data in standard formats',
                        },
                        {
                          title: 'Opt-out',
                          desc: 'Unsubscribe from communications',
                        },
                        {
                          title: 'Complaint',
                          desc: 'Lodge complaints with authorities',
                        },
                      ].map((item, index) => (
                        <div
                          key={index}
              ...
              <section className="bg-gradient-primary/10 rounded-xl border border-primary/20 p-8 text-center">
                ...
                <p className="text-muted-foreground mb-6 max-w-2xl mx-auto">
                  Our privacy team is here to help. Contact us for any questions
                  about how we handle your data.
                </p>
                <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                  <a
                    href="mailto:privacy@flexadigital.com"
