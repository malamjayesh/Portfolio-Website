  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="bg-gradient-hero relative overflow-hidden">
        ...
        <div
          className="absolute bottom-32 right-20 w-96 h-96 bg-primary/5 rounded-full blur-3xl animate-float"
        ...
        <div className="container mx-auto px-4 py-16 relative z-10">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="text-center mb-16">
              ...
              <p
                className="text-muted-foreground text-xl max-w-2xl mx-auto animate-fade-in"
                style={{ animationDelay: '0.2s' }}
              >
                Clear terms that protect both you and us. Read our service
                agreement and understand your rights.
              </p>
              <div
                className="flex items-center justify-center gap-2 mt-4 text-sm text-muted-foreground animate-fade-in"
            ...
            {/* Service Overview */}
            <div
              className="bg-gradient-card rounded-xl border border-primary/20 p-8 mb-12 animate-fade-in"
                ...
                {[
                  {
                    ...
                    desc: 'Custom websites & applications',
                  },
                  ...
                  {
                    title: 'UI/UX Design',
                    desc: 'User experience & interface',
                  },
                  {
                    title: 'Consulting',
                    desc: 'Technical strategy & guidance',
                  },
                ].map((service, index) => (
                  <div
                    key={index}
            ...
            <div className="space-y-8">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-muted-foreground mb-4">
                      By accessing and using Flexa Digital's services, you
                    ...
                    <div className="bg-accent/10 rounded-lg p-4 border border-accent/20">
                      <p className="text-sm text-accent font-medium">
                        ✓ These terms are legally binding and govern your use of
                        our services
                      </p>
                    </div>
                  </div>
                      ...
                      {[
                        {
                          ...
                          desc: 'For hosted services',
                        },
                        {
                          metric: '24/7',
                          label: 'Support Available',
                          desc: 'Critical issues only',
                        },
                        {
                          metric: '<2hrs',
                          label: 'Response Time',
                        ...
                        <div
                          key={index}
                          className="text-center bg-card/30 rounded-lg p-4 border border-border/30"
                        >
                  ...
                  <div className="flex-1">
                    ...
                    <div className="bg-orange-500/10 rounded-lg p-4 border border-orange-500/20 mb-4">
                      ...
                      <p className="text-sm text-muted-foreground">
                        ...
                        services. We are not liable for indirect, consequential,
                        or punitive damages.
                      </p>
                    </div>
                    <div className="grid md:grid-cols-2 gap-3">
                      ...
                      {[
                        {
                          ...
                          desc: 'Good faith discussion to resolve issues',
                        },
                        {
                          step: '2',
                          title: 'Mediation',
                          desc: 'Neutral third-party mediation',
                        },
                        {
                          step: '3',
                          title: 'Arbitration',
                          desc: 'Binding arbitration if needed',
                        },
                      ].map((item, index) => (
              ...
              <section className="bg-gradient-primary/10 rounded-xl border border-primary/20 p-8 text-center">
                ...
                <p className="text-muted-foreground mb-6 max-w-2xl mx-auto">
                  Our legal team is available to clarify any terms or answer
                  questions about our service agreement.
                </p>
                <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                  <a
                    href="mailto:legal@flexadigital.com"
                  ...
                  <a
                    ...
                    className="inline-flex items-center gap-2 bg-card text-foreground px-6 py-3 rounded-lg border border-border hover:bg-card/80 transition-colors"
                  >
