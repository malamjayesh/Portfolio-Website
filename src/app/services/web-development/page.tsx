      ...
      <main>
        ...
        <section className="relative min-h-[50vh] sm:min-h-[60vh] flex items-center justify-center bg-gradient-hero pt-24 sm:pt-32 pb-16 sm:pb-20">
          <div className="container mx-auto px-4 sm:px-6 text-center">
            ...
            <p
              className="text-base sm:text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto animate-fade-in px-4"
              style={{ animationDelay: '0.2s' }}
            >
              Modern, maintainable websites and SaaS platforms built with React,
              Next.js and serverless architectures—fast, secure and SEO-ready.
            </p>
          </div>
        </section>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8 max-w-6xl mx-auto">
              {[
                ...
                },
                {
                  ...
                  description:
                    'Scalable cloud applications with subscription management, user dashboards and API integrations.',
                },
                {
                ...
                },
                {
                  ...
                  description:
                    'Custom web apps with complex workflows, real-time features and database integration.',
                },
                {
                  title: 'Progressive Web Apps',
                  description:
                    'Fast, installable web apps that work offline and provide native-like experiences.',
                },
                {
                  title: 'Landing Pages',
                  description:
                ...
                <div
                  key={index}
                  className="bg-card border border-border rounded-xl sm:rounded-2xl p-4 sm:p-5 md:p-6 hover:shadow-card transition-all"
                >
              ...
              {[
                {
                  ...
                  description:
                    'Optimized for Core Web Vitals with <1s load times and 90+ Lighthouse scores',
                },
                {
                  icon: Shield,
                  title: 'Enterprise Security',
                  description:
                    'SSL certificates, secure authentication, data encryption and regular security audits',
                },
                {
                  icon: Smartphone,
                  title: 'Mobile First',
                ...
                },
                {
                  ...
                  title: 'Clean Code',
                  description:
                    'Well-documented, maintainable code with automated testing and CI/CD pipelines',
                },
              ].map((feature, index) => {
                ...
                return (
                  <div
                    key={index}
                    className="flex gap-3 sm:gap-4 bg-background border border-border rounded-xl sm:rounded-2xl p-4 sm:p-5 md:p-6"
                  >
        ...
        <section className="py-20 bg-secondary">
          <div className="container mx-auto px-6 text-center">
            ...
            <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
              Let's discuss your project requirements and create a scalable
              solution
            </p>
