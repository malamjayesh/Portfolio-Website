      ...
      <main>
        ...
        <section className="relative min-h-[60vh] flex items-center justify-center bg-gradient-hero pt-32 pb-20">
          <div className="container mx-auto px-6 text-center">
            ...
            >
              Enterprise integrations, CRM/ERP modules, dashboards and
              automation that reduce manual work and errors.
            </p>
          </div>
        </section>
              ...
              {[
                {
                  title: 'ERP Systems',
                  description:
                    'Enterprise resource planning systems for inventory, finance and operations management',
                },
                {
                  title: 'CRM Platforms',
                  description:
                    'Customer relationship management tools to track leads, deals and customer interactions',
                },
                {
                  title: 'HR Management',
                  description:
                    'Employee management, payroll, attendance tracking and performance review systems',
                },
                {
                  title: 'Custom Dashboards',
                  description:
                    'Real-time analytics dashboards with data visualization and reporting',
                },
                {
                ...
                },
                {
                  ...
                  description:
                    'Connect multiple systems and automate data flow between platforms',
                },
              ].map((solution, index) => (
                <div
                  key={index}
            ...
            <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
              {[
                ...
                },
                {
                  ...
                  description:
                    'Grows with your business without costly replacements',
                },
                {
                  icon: Code,
        ...
        <section className="py-20 bg-secondary">
          <div className="container mx-auto px-6 text-center">
            ...
            <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
              Let's discuss your unique requirements and create a solution that
              fits perfectly
            </p>
