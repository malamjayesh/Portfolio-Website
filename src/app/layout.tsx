...
export const metadata: Metadata = {
  ...
  description:
    'We build digital products that grow businesses. Product-led design, scalable engineering, clear results.',
  keywords:
    'web development, mobile apps, UI/UX design, digital marketing, cloud solutions',
