...
export default function Home() {
  ...
  const enterpriseStats = [
    ...
    },
    {
      ...
      sublabel: 'SLA Compliance',
      icon: Shield,
    },
    {
      number: '24/7',
      label: 'Global Support',
      sublabel: 'Multi-timezone Coverage',
      icon: Headphones,
    },
  ...
  const processSteps = [
    {
      ...
      description:
        'Deep-dive analysis of your business goals, user needs, and technical requirements',
      duration: '1-2 weeks',
      deliverables: [
    ...
    },
    {
      ...
      description:
        'User-centered design with interactive prototypes and comprehensive design systems',
      duration: '2-3 weeks',
    ...
    },
    {
      ...
      description:
        'Seamless deployment with monitoring, analytics setup, and post-launch optimization',
      duration: '1-2 weeks',
      deliverables: [
  ...
  const testimonialsFeatured = [
    {
      ...
      content:
        "Flexa Digital didn't just build our platform - they architected our entire technical foundation for scale. Their team's expertise in microservices and cloud architecture helped us handle 10x growth without breaking a sweat. The ROI has been phenomenal.",
      rating: 5,
      image:
    ...
    },
    {
      ...
      content:
        'Working with Flexa Digital was transformational. They modernized our legacy healthcare platform while maintaining HIPAA compliance and zero downtime. Their attention to security and scalability is unmatched in the industry.',
      rating: 5,
      image:
    ...
    },
    {
      ...
      content:
        'Flexa Digital delivered our omnichannel e-commerce platform ahead of schedule and under budget. The platform now processes $2B+ in annual transactions with sub-second response times. Exceptional team and results.',
      rating: 5,
      image:
  ...
  return (
    <div className="min-h-screen overflow-hidden">
      ...
      <main>
        ...
        <section className="py-8 sm:py-10 md:py-12 bg-background overflow-hidden">
            ...
            <div className="relative overflow-hidden">
              ...
              <div className="flex animate-scroll space-x-4 sm:space-x-6 md:space-x-8 hover:pause-animation">
                {[
                  ...
                  {
                    name: 'Axocera',
                    logo: 'https://www.google.com/s2/favicons?domain=axocera.com&sz=64',
                    fallback: '💻',
                    industry: 'Technology',
                    project: 'Tech Platform',
                    url: 'https://www.axocera.com/',
                  },
                ]
                  .concat([
                    {
        ...
        <section className="py-10 sm:py-12 md:py-14 bg-background relative overflow-hidden">
        ...
        <section className="py-10 sm:py-12 md:py-14 bg-background">
          <div className="container mx-auto px-4 sm:px-6">
            ...
            >
              ...
              <p className="text-base sm:text-lg md:text-xl text-muted-foreground max-w-4xl mx-auto px-4">
                Real projects, real impact. See how we've helped enterprises and
                startups achieve breakthrough results.
              </p>
            </motion.div>
        ...
        <section className="py-14 bg-secondary/30">
          <div className="container mx-auto px-6">
            ...
            >
              ...
              <p className="text-xl text-muted-foreground max-w-4xl mx-auto">
                Hear from CTOs, VPs of Engineering, and business leaders who've
                partnered with us
              </p>
            </motion.div>
        ...
        <section className="py-14 bg-background">
          <div className="container mx-auto px-6">
            ...
            >
              ...
              <p className="text-xl text-muted-foreground max-w-4xl mx-auto">
                Our battle-tested process ensures successful delivery, on time
                and within budget
              </p>
            </motion.div>
            ...
            <div className="space-y-12">
              {processSteps.map((step, index) => (
                ...
                >
                  ...
                  <div
                    className={`${index % 2 === 1 ? 'lg:col-start-1 lg:row-start-1' : ''} flex justify-center`}
                  >
        ...
        {/* Security & Compliance */}
        <section className="py-14 bg-gradient-to-br from-background via-primary/5 to-background">
          <div className="container mx-auto px-6">
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
            ...
            >
              ...
              <p className="text-xl text-muted-foreground max-w-4xl mx-auto">
                Bank-level security standards with comprehensive compliance
                certifications
              </p>
            </motion.div>
            ...
            >
              ...
              <div className="mt-8 text-center">
                <p className="text-muted-foreground mb-6">
                  Trusted by Fortune 30 companies for their most sensitive
                  projects
                </p>
        ...
        <section className="py-10 sm:py-12 md:py-14 bg-gradient-hero relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 sm:px-6 text-center relative z-10">
            ...
            >
              <Badge
                variant="outline"
                className="mb-4 sm:mb-6 bg-background/10 backdrop-blur-sm border-primary/20"
              >
                Ready to Scale?
              </Badge>
              ...
              <p className="text-base sm:text-lg md:text-xl text-muted-foreground mb-8 sm:mb-10 md:mb-12 max-w-4xl mx-auto px-4">
                Join 30+ successful companies who've transformed their business
                with our enterprise-grade solutions. Schedule a free strategy
                session and discover how we can accelerate your growth.
              </p>
              ...
              >
                ...
                >
                  <Button
                    size="lg"
                    className="bg-gradient-primary hover:shadow-glow transition-all duration-300 text-xl px-4 py-4 h-auto"
                    asChild
                  >
                    <Link href="/contact">
