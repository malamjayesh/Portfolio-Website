...
export default function Blog() {
  ...
  const blogPosts = [
    ...
    },
    {
      ...
      excerpt:
        'Complete guide to technical SEO and content optimization strategies for modern websites and applications.',
    ...
    },
    {
      ...
      excerpt:
        'Understanding user behavior and psychology in digital design. Create interfaces that users love and understand.',
    ...
    },
    {
      ...
      excerpt:
        'Essential DevOps practices for modern development teams. CI/CD, infrastructure as code, and monitoring strategies.',
    ...
    },
    {
      ...
      excerpt:
        'Deep dive into React Server Components and their benefits. Performance optimization and better user experiences.',
    ...
    },
    {
      ...
      excerpt:
        'Why mobile-first approach is crucial for modern web development. Responsive design principles and best practices.',
          ...
          <div className="container mx-auto px-6 text-center relative z-10">
            ...
            >
              ...
              <p className="text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto mb-8">
                Insights, tutorials, and industry trends from our engineering
                team. Stay updated with the latest in web development, design,
                and technology.
              </p>
